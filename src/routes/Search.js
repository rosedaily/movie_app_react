...
class Search extends React.Component {
  ...
  getSearchMovie = async () => {
    const ID_KEY = 'Jkl4yR1qJq1OwVnLfXgY';
    const SECRET_KEY = 'rE5zy4g6io';
        ...
        : (<form onSubmit={this.handleSubmit}>
          <div>
            <div className="input_div">
              <h1>영화 검색</h1>
              <input className="input_search" type="text" value={this.state.value} onChange={this.handleChange} placeholder="영화를 검색해보세요."/>
            </div>
